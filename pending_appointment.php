   ...
   <body class="fix-header card-no-border fix-sidebar">
      ...
      <div class="container">
         <table class="table table-bordered table-striped table-hover" id="myTable">
            <button class = "btn btn-info" data-toggle='modal' data-target='#sample1'>Arrange Schedule</button>
                       ...
                       <div class='modal-dialog'>
                         ...
                         <div class='modal-content'>
                           <div class='modal-header'>
                             ...
                             <h4 class='modal-title'>Do you want to arrange the appointments?</h4>
                           </div>
                           <div class='modal-body'>
                            <center> <a href='arrange_sched.php' class='btn btn-info'>Arrange</a></center>
                           </div>  
                         </div>
                       </div>
                    </div>
            ...
            <?php
               $get_data = "SELECT * FROM `appointments` INNER JOIN category on appointments.category=category.category_id INNER JOIN services ON appointments.service=services.service_id WHERE status='Pending' ";
               ...
               while($row = mysqli_fetch_array($run_data))
               {
                   ...
                   $atimeend = date('h:i A',strtotime($row['time_finish']));
                ...
                <tr>
                   ...
                   <td class='text-left'>$atimeend</td>
      ...
      <!-- Modal -->
      <?php
         $get_data = "SELECT * FROM `appointments` WHERE status='Pending' ";
         $run_data = mysqli_query($con,$get_data);
         ...
         <div id='$id' class='modal fade' role='dialog' tabindex='-1'>
           <div class='modal-dialog'>
             ...
             <div class='modal-content'>
               ...
               <div class='modal-body'>
                <center> <a href='delete_pending.php?id=$id' class='btn btn-danger'>Delete</a></center>
               </div>
                     ...
                     <div class='container' id='profile'> 
                         <div class='row'>
                             <div class='col-sm-12 col-md-12'>
                                 ...
                                 <strong>Time Start:</strong> $atime <br>
                                 <strong>Estimated Time End:</strong> $atimeend <br>
                                 </p>
                             </div>
                         </div>
